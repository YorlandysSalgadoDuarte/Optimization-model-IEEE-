...
degradation_U150_sin_mantenimiento=[]
...
#! Resultado de los tiempos de falla a trabajar========Es importante organizarlos antes de trabajar===============
# sorted(tiempos_de_falla_U12)
# sorted(tiempos_de_falla_U20)
# sorted(tiempos_de_falla_U50)
# sorted(tiempos_de_falla_U76)
# sorted(tiempos_de_falla_U100)
# sorted(tiempos_de_falla_U155)
# sorted(tiempos_de_falla_U197)
# sorted(tiempos_de_falla_U350)
# sorted(tiempos_de_falla_U400)
